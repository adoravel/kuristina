...
function ArtistTopTracks({ artist, entries }: { artist: string; entries: ArtistTopMedia[] }) {
	return (
		<message>
			<section>
				<accessory>
...
export default defineCommand({
	aliases: ["artisttracks", "artisttrack", "att", "at"],
	description: "Shows the top tracks for a given artist.",
	category: "fm",
	cooldownMs: 3_000,
	...
	async exec(ctx) {
		...
		await ctx.reply({ ...<ArtistTopTracks artist={query} entries={result.value} /> });
	},
});
